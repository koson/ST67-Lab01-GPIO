...
ESP32 เป็นระบบไมโครคอนโทรลเลอร์แบบ dual core ซึ่งมี CPU สถาปัตยกรรม Harvard ของบริษัท Xenia รุ่น LX6 จำนวนสองตัวอยู่ภายในชิปเดียวกัน
...
ทั้ง data และ instruction bus ต่างก็เข้าถึงข้อมูลแบบ little endear
...
||0x3FFA_0000| 0x3FFA_DAFF| 56 KB| Reserved| -|
...
|  | 4 KB |0x3FF4_A000 | 0x3FF4_FAFF |Reserved
| STDIO | 4 KB |0x3FF4_B000 | 0x3FF4_BFF |
| DUMA1 | 4 KB |0x3FF4_C000 | 0x3FF4_CAFF |
|  | 8 KB |0x3FF4_D000 | 0x3FF4_EFF |Reserved
| I2S0 | 4 KB |0x3FF4_F000 | 0x3FF4_FFFF |
| UARR1 | 4 KB |0x3FF5_0000 | 0x3FF5_0FFF |
|  | 8 KB |0x3FF5_1000 | 0x3FF5_2FFF |Reserved
| I2C0 | 4 KB |0x3FF5_3000 | 0x3FF5_3FFF |
| DUMA0 | 4 KB |0x3FF5_4000 | 0x3FF5_4FFF |
| STDIO Slave | 4 KB |0x3FF5_5000 | 0x3FF5_5FFF |
| RMT | 4 KB |0x3FF5_6000 | 0x3FF5_6FFF |
| PANT | 4 KB |0x3FF5_7000 | 0x3FF5_7FFF |
| STDIO Slave | 4 KB |0x3FF5_8000 | 0x3FF5_8FFF |
| LED PWM | 4 KB |0x3FF5_9000 | 0x3FF5_9FFF |
| eFuse Controller | 4 KB |0x3FF5_A000 | 0x3FF5_FAFF |
| Flash Encryption | 4 KB |0x3FF5_B000 | 0x3FF5_BFF |
|  | 8 KB |0x3FF5_C000 | 0x3FF5_DAFF |Reserved
| MCPWM0 | 4 KB |0x3FF5_E000 | 0x3FF5_EFF |
| TIME0 | 4 KB |0x3FF5_F000 | 0x3FF5_FFFF |
| TIME1 | 4 KB |0x3FF6_0000 | 0x3FF6_0FFF |
|  | 12 KB|0x3FF6_1000 | 0x3FF6_3FFF |Reserved
| SPI2 | 4 KB |0x3FF6_4000 | 0x3FF6_4FFF |
| SPI3 | 4 KB |0x3FF6_5000 | 0x3FF6_5FFF |
| SYSCO | 4 KB |0x3FF6_6000 | 0x3FF6_6FFF |
| I2C1 | 4 KB |0x3FF6_7000 | 0x3FF6_7FFF |
| SDDM | 4 KB |0x3FF6_8000 | 0x3FF6_8FFF |
| EMACR | 8 KB |0x3FF6_9000 | 0x3FF6_FAFF |
| THAI | 4KB |0x3FF6_B000 | 0x3FF6_BFF |
| MCPWM1 | 4 KB |0x3FF6_C000 | 0x3FF6_CAFF |
| I2S1 | 4 KB |0x3FF6_D000 | 0x3FF6_DAFF |
| UARR2 | 4 KB |0x3FF6_E000 | 0x3FF6_EFF |
...
– PALL_CLK เป็นสัญญาณนาฬิกาที่กำเนิดจากวงจรภายในชิป สามารถโปรแกรมให้อยู่ในช่วง 16 ถึง 128 MHz.
...
power consumption.
The CPU_CLK clock source is determined by the RTC_INTL_SOC_CLK_SEL register. PLL_CLK, PALL_CLK,
...
หากต้องการลดการใช้พลังงานก็สามารถเลือกแหล่งกำเนิดที่ให้สัญญาณนาฬิกาแก่ CPU ที่ต่ำลง ซึ่งแหล่งสัญญาณนาฬิกา CPU_CLK ถูกกำหนดโดยการกำหนดค่าให้แก่รีจิสเตอร์ RTC_CNTL_SOC_CLK_SEL PLL_CLK, APLL_CLK, RC_FAST_CLK และ XTL_CLK  
